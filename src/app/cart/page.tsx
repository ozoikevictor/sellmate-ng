        ...
        <nav className="mx-auto flex h-[72px] max-w-7xl items-center justify-between gap-3 px-4 sm:px-6">
          <Link href={storeHref} className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="hidden text-xs font-semibold text-slate-500 sm:block">Secure order review</p>
            </div>
          </Link>
          <div className="flex shrink-0 items-center gap-2">
            <Link href={storeHref} className="rounded-md border border-slate-300 bg-white px-3 py-2 text-xs font-black text-slate-800 shadow-sm hover:border-orange-300 hover:bg-orange-50 sm:px-4 sm:text-sm">Shop</Link>
            <Link href={checkoutHref} className="rounded-md bg-orange-500 px-3 py-2 text-xs font-black text-white shadow-sm hover:bg-orange-600 sm:px-5 sm:text-sm">Checkout</Link>
          </div>
        </nav>
      </header>
